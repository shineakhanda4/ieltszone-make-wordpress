class Header extends HTMLElement {
    constructor() {
        ...
        header.innerHTML = `
            ...
            <nav>
    <a href="/" title="Home"><i class="fas fa-home-alt"></i><span class="nav-text">Home</span></a>
    <a href="/info" title="About Us"><i class="fas fa-info-circle"></i><span class="nav-text">About</span></a>
    <a href="/services" title="Our Services"><i class="fas fa-concierge-bell"></i><span class="nav-text">Services</span></a>
    <a href="/contact" title="Contact Us"><i class="fas fa-envelope"></i><span class="nav-text">Contact</span></a>
            </nav>
        `;
